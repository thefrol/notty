...
//
// Раньше этот пакет назывался смс, но в реальности это один из
// адаптеров - для того сервиса для которого задумался.
// возможно будут и другие, поэтому это конкретный адаптер
package fabrique
